    ...
    <div className="p-6 max-w-2xl mx-auto">
      ...
      <div className="space-y-4 bg-secondary/20 border border-border rounded-lg p-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-sm font-medium text-foreground mb-2">Veins per Chunk</label>
            <input
              type="number"
        ...
        <div>
          <label className="block text-sm font-medium text-foreground mb-2">Biomes (optional)</label>
          <input
            type="text"
