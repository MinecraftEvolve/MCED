...
export const CraftingShapelessEditor: React.FC<CraftingShapelessEditorProps> = ({
  instancePath,
  onSave,
  initialRecipe,
}) => {
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-2 gap-8">
        ...
        <div>
          ...
          <div className="bg-muted/50 border border-primary/20 rounded-lg p-4 min-h-[200px]">
            <div className="flex flex-wrap gap-2">
              ...
              {ingredients.length < 9 && (
                <button
                  ...
                  className="w-16 h-16 bg-secondary border-2 border-dashed border-primary/20 rounded hover:border-primary transition-colors flex items-center justify-center"
                >
