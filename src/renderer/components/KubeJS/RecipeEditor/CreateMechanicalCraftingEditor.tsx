...
export const CreateMechanicalCraftingEditor: React.FC<CreateMechanicalCraftingEditorProps> = ({
  instancePath,
  onSave,
  initialRecipe,
}) => {
  ...
  const [selectedSlot, setSelectedSlot] = useState<{ row: number; col: number } | "output" | null>(
    null
  );
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <select
          ...
          className="w-48 bg-secondary border border-primary/20 text-foreground px-3 py-2 rounded focus:outline-none focus:border-primary"
        >
      ...
      <div>
        <label className="block text-sm font-medium text-foreground mb-3">
          Crafting Pattern ({gridSize}x{gridSize})
        </label>
        <div
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <input
              ...
              min="1"
              max="64"
              className="w-20 bg-secondary border border-primary/20 text-foreground px-3 py-2 rounded focus:outline-none focus:border-primary"
            />
          </div>
        </div>
      </div>
